...
# 高德 POI 类型码映射表
AMAP_CATEGORY_CODES = {
    # 注意：只用叶子节点，不混入父类（父类会把所有子类 POI 一起拉回来）
    "公园":   "110101|110102|110103",           # 综合公园|社区公园|专类公园（去掉110100父类）
    "咖啡":   "050118|050119",                  # 咖啡厅|茶馆茶艺馆（去掉050000餐饮父类）
    "书店":   "080703|060101",                  # 书店|文化用品店（去掉060100商场父类）
    "博物馆": "080300|080301|080302",
    "餐厅":   "050100|050200|050300|050400|050500",  # 中餐|外国餐|快餐|小吃|其他餐饮（不用050000父类）
    "商场":   "060201|060202",                  # 购物中心|超市（去掉060200购物父类）
    "户外":   "110101|110200|110201",            # 公园|风景名胜|山岳
    "健身":   "090301|090302",
    "酒吧":   "050100",
    "电影院": "120201",                          # 电影院（精确子类）
    "KTV":    "050500",                          # 歌舞娱乐
...
async def parse_intent_with_ai(
    ...
    poi_types = "|".join(all_codes) if all_codes else "110101|050118|080703|080300"
